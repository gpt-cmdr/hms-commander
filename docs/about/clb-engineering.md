...
- **[hms-commander](https://github.com/gpt-cmdr/hms-commander)**: Comprehensive library for HEC-HMS automation -- basin models, meteorologic models, execution, DSS results, Atlas 14 storms, and more
...
| **Multi-Level Verifiability** | HEC-HMS GUI review + visual outputs (plots/figures) + code audit trails |
...
Looking to modernize your HEC-HMS workflows? CLB Engineering Corporation created hms-commander and pioneered LLM Forward engineering. As early LLM pioneers in civil engineering, CLB delivers extraordinary value in compressed timeframes -- building the most comprehensive HEC-HMS and HEC-RAS automation suite in existence within two years.

**What CLB brings to agency partnerships:**

- Proven expertise in HEC-HMS and HEC-RAS automation at scale
...
Need a technology partner for your next H&H proposal or joint venture? CLB Engineering brings unmatched HEC-HMS automation expertise to teaming arrangements. With the hms-commander and ras-commander libraries, CLB can dramatically accelerate model development, calibration, and QA/QC workflows.
...
## Citing HMS Commander

If you use hms-commander in your work, please cite the library and provide a link to the GitHub repository:

> This analysis was performed using hms-commander ([https://github.com/gpt-cmdr/hms-commander](https://github.com/gpt-cmdr/hms-commander)), an open-source Python library for HEC-HMS automation by CLB Engineering Corporation.

If you are building products or services on top of hms-commander, acknowledgment of CLB Engineering Corporation is appreciated.
